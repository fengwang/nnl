...
namespace numeric
{
    ...
    namespace float16_t_private
    {
        ...
        inline constexpr float16 float32_to_float16( float input ) noexcept
        {
            ...
            f32.float_ = input;
            float16 f16;
            f16.bits_ = nnl_half::float_to_half( f32.bits_ );
            return f16;
        }
        ...
        {
            float32 f32;
            f32.bits_ = nnl_half::half_to_float( input );
            return f32;
        }
    ...
    struct float16_t
    {
        ...
        {
            data_.bits_ = nnl_half::half_add( data_.bits_, v.data_.bits_ );
            return *this;
        }

        constexpr inline float16_t& operator -= ( float16_t v ) noexcept
        {
            data_.bits_ = nnl_half::half_sub( data_.bits_, v.data_.bits_ );
            return *this;
        }

        constexpr inline float16_t& operator *= ( float16_t v ) noexcept
        {
            data_.bits_ = nnl_half::half_mul( data_.bits_, v.data_.bits_ );
            return *this;
        }
        ...
        constexpr inline float16_t& operator += ( float v ) noexcept
        {
            ...
            data_.bits_ = nnl_half::half_add( data_.bits_, f16.bits_ );
            return *this;
        }
        ...
        {
            auto f16 =  float16_t_private::float32_to_float16( v );
            data_.bits_ = nnl_half::half_sub( data_.bits_, f16.bits_ );
            return *this;
        }
        ...
        {
            auto f16 =  float16_t_private::float32_to_float16( v );
            data_.bits_ = nnl_half::half_mul( data_.bits_, f16.bits_ );
            return *this;
        }
