...
namespace nnl
{
    ...
    struct view_2d
    {
        ...
        template< std::integral Int, std::integral Jnt >
        constexpr view_2d( T* data, Int row, Jnt col, bool transposed=false ) noexcept : data_{data}, row_{static_cast<unsigned long>(row)}, col_{static_cast<unsigned long>(col)}, transposed_{transposed} {}
        ...
        template< std::integral Int, std::integral Jnt >
        constexpr view_2d( const T* data, Int row, Jnt col, bool transposed=false ) noexcept : data_{const_cast<T*>(data)}, row_{static_cast<unsigned long>(row)}, col_{static_cast<unsigned long>(col)}, transposed_{transposed} {}
